...
public class VehicleQueueTest {
    ...
    public void testConstructorIllegalArgument() {
        try {
            ...
            fail("VehicleQueue.VehicleQueue() should throw an IllegalArgumentException if the entryDelay argument non-positive!");
        ...
        try {
            ...
            fail("VehicleQueue.VehicleQueue() should throw an IllegalArgumentException if the exitDelay argument non-positive!");
        } catch (IllegalArgumentException e) {
        }
        ...
        try {
            ...
            fail("VehicleQueue.VehicleQueue() should throw an IllegalArgumentException if the trafficLightRate argument is non-positive!");
        } catch (IllegalArgumentException e) {
        }
